...
#include "/home/zjl/data/polycom/ipnc_rdk_3_5/Source/ti_tools/ipnc_psp_arago/kernel/drivers/usb/gadget/uvc.h"
...
uvc_video_reqbufs(struct uvc_device *dev, int nbufs)
{
	...
	for (i = 0; i < rb.count; ++i) {
		...
		dev->mem[i] = mmap(0, buf.length, PROT_READ | PROT_WRITE, MAP_SHARED, dev->
fd, buf.m.offset);
			   ...
			   int iframe, int iformat)
{
	...
	ctrl->dwMaxPayloadTransferSize = 512;	/* TODO this should be filled by the 
driver. */
